...
public class Ninja extends Player {
    ...
    protected void setStatsu(String name) {
        this.hp = calcStatus(this.name, CharaConstants.Ninja.MAX_HP, CharaConstants.Ninja.MIN_HP,
                CharaConstants.HP_INDEX);
        this.mp = calcStatus(this.name, CharaConstants.Ninja.MAX_MP, CharaConstants.Ninja.MIN_MP,
                CharaConstants.MP_INDEX);
        this.str = calcStatus(this.name, CharaConstants.Ninja.MAX_STR, CharaConstants.Ninja.MIN_STR,
                CharaConstants.STR_INDEX);
        this.def = calcStatus(this.name, CharaConstants.Ninja.MAX_DEF, CharaConstants.Ninja.MIN_DEF,
                CharaConstants.DEF_INDEX);
        this.agi = calcStatus(this.name, CharaConstants.Ninja.MAX_AGI, CharaConstants.Ninja.MIN_AGI,
                CharaConstants.AGI_INDEX);
        this.luck = calcStatus(this.name, CharaConstants.Ninja.MAX_LUCK, CharaConstants.Ninja.MIN_LUCK,
