...
public class Wizard extends Player {
    ...
    protected void setStatsu(String name) {
        this.hp = calcStatus(this.name, CharaConstants.Wizard.MAX_HP, CharaConstants.Wizard.MIN_HP,
                CharaConstants.HP_INDEX);
        this.mp = calcStatus(this.name, CharaConstants.Wizard.MAX_MP, CharaConstants.Wizard.MIN_MP,
                CharaConstants.MP_INDEX);
        this.str = calcStatus(this.name, CharaConstants.Wizard.MAX_STR, CharaConstants.Wizard.MIN_STR,
                CharaConstants.STR_INDEX);
        this.def = calcStatus(this.name, CharaConstants.Wizard.MAX_DEF, CharaConstants.Wizard.MIN_DEF,
                CharaConstants.DEF_INDEX);
        this.agi = calcStatus(this.name, CharaConstants.Wizard.MAX_AGI, CharaConstants.Wizard.MIN_AGI,
                CharaConstants.AGI_INDEX);
        this.luck = calcStatus(this.name, CharaConstants.Wizard.MAX_LUCK, CharaConstants.Wizard.MIN_LUCK,
