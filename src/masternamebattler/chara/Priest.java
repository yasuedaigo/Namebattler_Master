...
public class Priest extends Player {
    ...
    protected void setStatsu(String name) {
        this.hp = calcStatus(this.name, CharaConstants.Priest.MAX_HP, CharaConstants.Priest.MIN_HP,
                CharaConstants.HP_INDEX);
        this.mp = calcStatus(this.name, CharaConstants.Priest.MAX_MP, CharaConstants.Priest.MIN_MP,
                CharaConstants.MP_INDEX);
        this.str = calcStatus(this.name, CharaConstants.Priest.MAX_STR, CharaConstants.Priest.MIN_STR,
                CharaConstants.STR_INDEX);
        this.def = calcStatus(this.name, CharaConstants.Priest.MAX_DEF, CharaConstants.Priest.MIN_DEF,
                CharaConstants.DEF_INDEX);
        this.agi = calcStatus(this.name, CharaConstants.Priest.MAX_AGI, CharaConstants.Priest.MIN_AGI,
                CharaConstants.AGI_INDEX);
        this.luck = calcStatus(this.name, CharaConstants.Priest.MAX_LUCK, CharaConstants.Priest.MIN_LUCK,
